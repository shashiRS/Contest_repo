...
class WhatNewWindow(QDialog, Ui_Dialog):
    ...
    def update_latest_release_info(self):
        ...
        self.release_more_details.setText(
            f"Details: 📑 <a href='{ui_helper.DOC_BASE_URL}'>User Manual</a> | "
            f"🧾 <a href='{ui_helper.RELEASE_NOTES}'>Release Notes</a> | "
            f"⏬ <a href='{ui_helper.INSTALLATION_LINK}'>Installation</a> | "
            f"🐍 <a href='{ui_helper.DOC_PY_LIBS_LINK}'>ConTest Python Libraries</a>"
        )
