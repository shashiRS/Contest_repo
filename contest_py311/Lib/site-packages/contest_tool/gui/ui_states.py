"""
    ...
    :synopsis:
        This file contains control class for the ConTest GUI state-machine which handles the states of GUI at each
        different level.
"""
import os
import sys
...
if "CONTEST_EXTERNAL_RELEASE" not in os.environ:
    ...
    from gui.design_files.common_gui_ext import Ui_MainWindow
...
class UIStates(QMainWindow, Ui_MainWindow):
    ...
    def initial_state_actions(self):
        ...
        self.action_exe_record.setEnabled(False)
        ...
        # Load settings
        self.action_reopen_last_opened_configuration.setChecked(self.user_config.reopen_last_configuration)
